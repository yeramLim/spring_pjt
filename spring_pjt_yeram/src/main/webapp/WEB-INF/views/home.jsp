...
<html lang="en">
    <head>
        ...
        <title>메인페이지 - Agency - Start Bootstrap Theme</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="reservation/reservation">Reservation</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="board/list">Board</a></li>
...
<!--                         <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#portfolio">Portfolio</a></li>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#services">Reservation(예약)</a>
            </div>
        </header>
        <!-- Services-->
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">궁금하신 사항이 있으시면 언제든 문의주세요.</h3>
                </div>
